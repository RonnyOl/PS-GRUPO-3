...
export default function ShoppingPage() {
    ...
    const fetchGames = async () => {
        try {
            ...
            setError(
                "No se pudo conectar con el servidor de Vapor."
            );
                                    ...
                                    >
                                        ...
                                        <div className="p-4 flex-grow flex flex-col justify-between space-y-3">
                                                ...
                                                {game.categories?.length > 0 && (
                                                    <div className="flex flex-wrap gap-1 mt-2">
                                                        ...
                                                        {game.categories.map((cat, idx) => (
                                                            <span
                                                                key={idx}
                                                                className="px-1.5 py-0.5 bg-[#1b2838] text-cyan-400 text-[8px] font-bold uppercase tracking-wider rounded border border-[#2a475e]/30"
                                                            >
                                                                {cat}
                                                            </span>
                                                        ))}
                                            ...
                                            <div className="flex items-center justify-between pt-2 border-t border-white/5">
                                                ...
                                                <span
                                                    className={`text-sm font-black ${isFree
                                                        ? "text-emerald-400"
                                                        : "text-white"
                                                        }`}
                                                >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 rounded bg-[#2a475e] hover:bg-[#3b5c77] transition-all"
                                                    >
